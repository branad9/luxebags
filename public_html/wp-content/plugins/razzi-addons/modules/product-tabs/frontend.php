...
class FrontEnd {
	...
	const POST_TYPE     = 'razzi_product_tabs';
	const OPTION_NAME   = 'razzi_product_tabs';
	...
	public function display_size_guide() {
		...
		$guide_settings = get_post_meta( $product->get_id(), 'razzi_product_tabs', true );
	...
	public function get_product_size_guide_id( $object = false ) {
		...
		$size_guide = get_post_meta( $_product->get_id(), 'razzi_product_tabs', true );
