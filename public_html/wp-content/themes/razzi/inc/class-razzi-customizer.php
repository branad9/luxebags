...
class Customizer {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'razzi-customize', get_template_directory_uri() . '/assets/js/backend/customizer.js', array( 'jquery' ), '', true );
	}
	...
	public function enqueue_preview_scripts() {
		...
		wp_enqueue_script( 'razzi-customizer-preview', get_template_directory_uri() . '/assets/js/backend/customizer-preview.js', array( 'customize-preview' ), '', true );
	}
